...
man_pages = [
    (master_doc, 'mpyc', 'MPyC Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'MPyC', 'MPyC Documentation', author,
    'MPyC', 'Secure Multiparty Computation in Python', 'Security'),
]
